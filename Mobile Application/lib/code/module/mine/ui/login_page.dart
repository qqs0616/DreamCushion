...
class _LoginModel extends AppBaseVm {
  ...
  void login() {
    ...
    UserServiceRepository.login(userName!, password!, cancelToken).then(
        (IntensifyEntity<User> value) {
      dismissLoading();
      if (_isSavePassword) {
        _saveLoginStatus();
      }
